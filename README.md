...
>[!CAUTION]
>Images are built from [upstream Solr](https://github.com/apache/solr-docker#readme). Re-pull to pick up Solr patch releases baked at build time. Solr **9.9** is the pinned minor for Solr 9 tags. Solr **10.0** is experimental (tracking [ckan/ckan-solr#20](https://github.com/ckan/ckan-solr/pull/20)).
...
| 2.12 | 9.9 | `ghcr.io/mjanez/ckan-solr:2.12-solr9-spatial` | Also tagged `2.12-solr9.9-spatial` |
| 2.12 | 9.9 | `ghcr.io/mjanez/ckan-solr:2.12-solr9` | Stock CKAN schema only |
...
### Solr 10 (experimental)

CKAN docs still list Solr 8/9 only. Use these tags for testing; the schema `name` must match the CKAN series (`ckan-2.11` / `ckan-2.12`).

| CKAN | Solr | Image | Notes |
| --- | --- | --- | --- |
| 2.11 | 10.0 | `ghcr.io/mjanez/ckan-solr:2.11-solr10-spatial` | Also tagged `2.11-solr10.0-spatial` |
| 2.11 | 10.0 | `ghcr.io/mjanez/ckan-solr:2.11-solr10` | Stock CKAN schema only |
| 2.12 | 10.0 | `ghcr.io/mjanez/ckan-solr:2.12-solr10-spatial` | Also tagged `2.12-solr10.0-spatial` |
| 2.12 | 10.0 | `ghcr.io/mjanez/ckan-solr:2.12-solr10` | Stock CKAN schema only |
...
- JTS Core **1.19.0** (Solr 8/9) or **1.20.0** (Solr 10, same pin as upstream)
...
make build CKAN_VERSION=2.12        # CKAN 2.12 / Solr 9.9

cd ../solr-10
make build                          # CKAN 2.11 / Solr 10.0
make build CKAN_VERSION=2.12        # CKAN 2.12 / Solr 10.0
